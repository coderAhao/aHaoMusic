...
__DEFINE__(1643159962639, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1643159962640,"./event-store":1643159962641}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1643159962640, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1643159962641, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1643159962640,"./utils":1643159962642}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1643159962642, function(require, module, exports) {
...
return __REQUIRE__(1643159962639);
})()
